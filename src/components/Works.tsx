...
import { IProject, ITag, projects } from '../constants'
import { fadeIn, textVariant } from '../utils/motion'

const ProjectCard: React.FC<IProject & { index: number }> = ({
  index,
  name,
  description,
  tags,
...
const Works: React.FC = () => {
  return (
    <>
      ...
      <div className="mt-20 flex flex-wrap gap-7 justify-center sm:justify-center">
